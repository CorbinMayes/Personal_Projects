...
public class MyEventAdapter extends ArrayAdapter<Event>{
    ...
    public MyEventAdapter(@NonNull Context context, ArrayList<Event> resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        MyEventAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            viewHolder = new MyEventAdapter.ViewHolder();
            ...
            viewHolder = (MyEventAdapter.ViewHolder) convertView.getTag();
        }
        assert event != null;

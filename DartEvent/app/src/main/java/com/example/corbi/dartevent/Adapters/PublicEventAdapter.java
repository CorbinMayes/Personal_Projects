...
public class PublicEventAdapter extends ArrayAdapter<Event>{

    public PublicEventAdapter(@NonNull Context context, ArrayList<Event> resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        PublicEventAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            viewHolder = new PublicEventAdapter.ViewHolder();
            ...
            viewHolder = (PublicEventAdapter.ViewHolder) convertView.getTag();
        }
        assert event != null;
